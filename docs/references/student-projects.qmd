...
If you want to do a student project with me as a supervisor there are a couple of topics (X) that I am interested in at the moment:
...
### Chosing an approach
It is important to consider which approach to take. This will determine the kind of project, required steps and outcomes, how the work is evaluated and assessed, and the activities that will take priority in the project. I supervise three different types of projects:

- Prototyping project: Develop and evaluate tools and technigues for X
- Design project: Involve users (U) in exploring and designing a prototype on X for U
- Empirical project: Study X within a specific context

For **constructive projects**, you will spend time reading related work, developing various experimental prototypes and evaluate these in a user study. This involves designing the study and analysing the qualitative and quantitative results. 

For **design projects**, you will have to recruit a group of users and go through a full design project with workshops and iterations toward a final prototype. This can be evaluated through a user study, a qualitative analysis or through how the participants responded to the process and design.

For **empirical projects**, you will have to identify an appropriate domain and work-related context to study. This will typically be studying how people work with X, their activities, tools and challenges. You will spend time doing field work, identifying appropriate ways of analysing the insights and develop rich descriptions and/or design implications. 

Some projects combine elements from the above. Every project develop differently.

For data-centric projects exploring interaction technigues, I recommend chosing a couple of starting points to focus on:

- A step in the data analysis process: discovery, exploration, wrangling, analysis and/or presentation
- A genre of interaction techniques: traditional user interface, graphical interaction, physicalizations, sketching, colleborative, natural language, embodied etc?
- Data set/platform: traffic, weather, energy, statistical, business, cultural, political, publications data.

### Developing the problem statement
The first step is to develop a problem statement. I follow the approach outlined in the book "Craft of Research" () on moving from topics to questions to problems (section II). Before we start the project, I will guide you in and ask you to write a short half/full page synopsis outlining the project. The synopsis should contain the following elements:
...
This helps *us* identify the starting point of the project. And more importantly, if you cannot o write a short synopsis on something you intend to spend a semester on -- how are you going to complete the project and write up the final assignment?

### Project and supervision
You will start the project from the synopsis. The task is to expand it into a full assignment that can be evaluated and graded towards the end. This has to happen in parallel with the activities (the prototyping, design project or empirical work) to ensure that the document is updated and grows as you start honing in on the problem and begin to find answers. 
...
| **5** | **M5: All** | **WRITE, EDIT, WRITE** |

: Table 1: Project milestone overview -- milage and order may vary depending on project
